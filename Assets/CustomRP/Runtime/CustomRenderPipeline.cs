...
public class CustomRenderPipeline : RenderPipeline
{
    ...
    void ShadowMappingPass(ScriptableRenderContext context, Camera camera)
    {
        ...
        {
            // 生成 Mask, 模糊 Mask
            cmd.Blit(gbufferID[0], tempTex1, new Material(Shader.Find("Custom RP/preshadowmappingpass")));
            cmd.Blit(tempTex1, tempTex2, new Material(Shader.Find("Custom RP/blurNx1")));
            cmd.Blit(tempTex2, shadowMask, new Material(Shader.Find("Custom RP/blur1xN")));
        }    

        // 生成阴影, 模糊阴影
        cmd.Blit(gbufferID[0], tempTex3, new Material(Shader.Find("Custom RP/shadowmappingpass")));
        cmd.Blit(tempTex3, shadowStrength, new Material(Shader.Find("Custom RP/blurNxN")));
    ...
    void FinalPass(ScriptableRenderContext context, Camera camera)
    {
        ...
        Material mat = new Material(Shader.Find("Custom RP/finalpass"));
